...
function makeRepo() {
  return new CloudMonthRepository(new InMemoryStorageAdapter())
}
...
async function seedDay(repo: CloudMonthRepository, date: string, period: WorkPeriod) {
  await repo.updateDay(date, (day) => ({ ...day, windows: [period] }))
}

describe('CloudMonthRepository — confirmDay / unconfirmDay', () => {
...
describe('CloudMonthRepository — toggleLocation', () => {
...
describe('CloudMonthRepository — saveNote', () => {
...
describe('CloudMonthRepository — resetDay', () => {
...
describe('CloudMonthRepository — saveWorkPeriod', () => {
...
describe('CloudMonthRepository — saveWorkPeriodWithAbsorbed', () => {
...
describe('CloudMonthRepository — removeWorkPeriod', () => {
...
describe('CloudMonthRepository — setPeriodCategory', () => {
...
describe('CloudMonthRepository — addSubtask / removeSubtask', () => {
...
describe('CloudMonthRepository — stopWorkPeriod', () => {
...
describe('CloudMonthRepository — startLiveSubtask / stopLiveSubtask', () => {
...
describe('CloudMonthRepository — openWorkPeriod', () => {
...
describe('CloudMonthRepository — closeOpenWorkPeriod', () => {
...
describe('CloudMonthRepository — clearCache', () => {
  it('forces a re-read from storage after cache is cleared', async () => {
