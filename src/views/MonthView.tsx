  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-wrap gap-3 text-xs">
        ...
        <span className="flex items-center gap-1"><span className="inline-block h-3 w-3 rounded bg-yellow-100 border border-yellow-300" /> Incomplete</span>
        ...
        <span className="flex items-center gap-1"><span className="relative inline-block h-3 w-3 rounded bg-white border border-gray-300"><span className="absolute bottom-0 left-1/2 -translate-x-1/2 h-1 w-1 rounded-full bg-emerald-700" /></span> Today</span>
