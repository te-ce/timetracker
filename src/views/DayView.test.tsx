...
vi.mock('../components/WorkPeriodPanel', () => ({
  WorkPeriodPanel: () => null,
}))

vi.mock('../components/OvertimeBar', () => ({
  OvertimeBar: () => null,
}))
...
describe('DayView', () => {
  ...
  describe('mutations', () => {
    ...
    it('shows reset confirmation dialog when Reset all is clicked', async () => {
      render(<DayView />, { wrapper: makeWrapper(monthRepo) })
