...
describe('ConfirmDialog', () => {
  ...
  it('calls onConfirm when confirm button is clicked', async () => {
    ...
    render(<ConfirmDialog title="Confirm" message="Do it?" onConfirm={onConfirm} onCancel={() => {}} />)
  ...
  it('calls onCancel when cancel button is clicked', async () => {
    ...
    render(<ConfirmDialog title="Confirm" message="Do it?" onConfirm={() => {}} onCancel={onCancel} />)
  ...
  it('renders the dialog with role="dialog" and aria-modal', () => {
    render(<ConfirmDialog title="Title" message="Message" onConfirm={() => {}} onCancel={() => {}} />)
