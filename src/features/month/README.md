...
| `overtimeCarryOver.ts` | Accumulates overtime from prior months                          |
...
Carry-over calculation: scans all months before the current one, sums `(workedHours - targetHours)` per month.
