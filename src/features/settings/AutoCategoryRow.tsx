import { calculateAutoCategory } from '../../shared/autoCategory'
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        {isOverbooked && (
          <span className="rounded bg-red-100 dark:bg-red-900/30 px-2 py-0.5 text-xs font-medium text-red-700 dark:text-red-400">
            Overbooking
          </span>
        )}
      </div>
