...
import { loadExcelHandle, saveExcelHandle, clearExcelHandle, verifyPermission } from '../storage/folder-handle-store'
    ...
    <section className="flex flex-col gap-3">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          By default the app reads Excel files from the same folder as app data. Set a separate folder if your
          workbooks live elsewhere.
        </p>
      </div>
