...
describe('CategorySettings', () => {
  ...
  it('removes a category', async () => {
    const config: AppConfig = {
      ...
      categoryOrder: ['_LEAVE', '_OTHER', '_COREMEDIA', '_RELEASE', '_SUPPORT', '_GUILDS', '_MAINT', '_INFRA', '_ARCH', '_TESTWATCH', 'ToRemove'],
    }
  ...
  it('reorders categories via drag-and-drop events', async () => {
    const config: AppConfig = {
      ...baseConfig,
      customCategories: [],
      categoryOrder: ['_LEAVE', '_OTHER', '_COREMEDIA', '_RELEASE', '_SUPPORT', '_GUILDS', '_MAINT', '_INFRA', '_ARCH', '_TESTWATCH'],
    }
    const repo = new InMemoryConfigRepository(config)
    render(<CategorySettings repository={repo} />, { wrapper: makeWrapper() })
