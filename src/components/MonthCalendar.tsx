...
const STATUS_COLORS: Record<DayStatus, string> = {
  ...
  'today-incomplete': 'bg-blue-100 text-blue-800 hover:bg-blue-200 ring-2 ring-blue-400',
...
const HATCHED_STYLES: Partial<Record<DayStatus, CSSProperties>> = {
  ...
  'today-incomplete': {
    backgroundImage:
      'repeating-linear-gradient(135deg, transparent, transparent 4px, rgba(217,119,6,0.25) 4px, rgba(217,119,6,0.25) 8px)',
  },
