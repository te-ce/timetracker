...
export function IncompleteBanner({ incompleteDates, onNavigate }: Props) {
  ...
  return (
    <div role="alert" className="rounded-lg border border-amber-300 dark:border-amber-700 bg-amber-50 dark:bg-amber-900/30 px-4 py-3">
      <p className="text-sm font-semibold text-amber-800 dark:text-amber-400">{incompleteDates.length} days need attention</p>
